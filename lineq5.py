...
#    ld=data.tolist()
    ...
    cur.execute('select checkresmult(%s::numeric[],%s::numeric[],%s::numeric[])',[data1[0:4,0].astype(float).tolist(),data2[0:4,0].astype(float).tolist(),data3[0:4,0].astype(float).tolist()])
