...
for i in range(0, len(marketCatalogueResult)): 
   #                  if (typeof response.result[i].competition != 'undefined')
   #                  {
   #                  if (response.result[i].competition.name=='Barclays Premier League')
   #                  {
	print json.dumps(marketCatalogueResult[i])
